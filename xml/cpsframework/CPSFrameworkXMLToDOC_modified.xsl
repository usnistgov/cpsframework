...
<!-- <xsl:stylesheet xmlns:cps="cpsframework" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt"  
xmlns="http://www.w3.org/1999/xhtml" xmlns:l="lookup" exclude-result-prefixes="msxsl l" version="1.0"> -->

<xsl:stylesheet xmlns:cps="cpsframework" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"  
xmlns:exsl="http://exslt.org/common" extension-element-prefixes="exsl" 
xmlns="http://www.w3.org/1999/xhtml" xmlns:l="lookup"  version="1.0">
...
<xsl:variable name="AspectLookupTableString">
	...
	<!-- <xsl:variable name="AspectLookupTable" select="AspectLookupTableString"/>  -->

	<!-- <xsl:variable name="AspectLookupTable" select="msxsl:node-set($AspectLookupTableString)"/> -->

	<xsl:variable name="AspectLookupTable" select="exsl:node-set($AspectLookupTableString)"/>
	...
	<xsl:template match="/" name="initial-template">
		<html>
			...
			<body>
				<xsl:if test="cps:CPSFramework/BusinessCase">
					<h1>
				...
				<xsl:if test="cps:CPSFramework/UseCase">
...
-->
				...
				<xsl:if test="cps:CPSFramework/InteractionLibrary">
					<h1>
					6       Interactions
				</h1>
					<h2>
				...
				<xsl:if test="cps:CPSFramework/CPSLibrary">
					<h1>
					7 CPS Library
				</h1>
					<h2>
